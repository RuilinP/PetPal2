...
from .views import ShelterListCreateView, ShelterRetrieveUpdateView, ShelterDestroyPetsView, ShelterDestroyNotificationsView, \
    SeekerCreateView, SeekerRetrieveUpdateView, SeekerDestroyApplicationsView, SeekerDestroyNotificationsView 
...
urlpatterns = [
    ...
    path('shelters/<int:pk>/notifications/', ShelterDestroyNotificationsView.as_view(), name='shelter-destroy-notifications'),
    ...
    path('seekers/<int:pk>/notifications/', SeekerDestroyNotificationsView.as_view(), name='seeker-destroy-notifications'),
